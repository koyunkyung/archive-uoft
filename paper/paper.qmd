...
The 2023 Natality Dataset provides detailed records of maternal and neonatal health outcomes across diverse populations in the United States. This obervational dataset aggregates data from hospital records, birth certificates, and surveys completed by healthcare providers. Its comprehensive scope includes variables like maternal age, gestational age, socio-economic status, and the application of specific labor-related treatments.

--- The dataset represents a census of live births in the U.S., negating the need for probabilistic sampling. However, for this study, we employed a stratified sampling approach to create a balanced subset. Treatments like steroids and antibiotics often show skewed distributions, with underrepresentation in certain socio-economic or geographic groups. Stratified sampling ensures adequate representation of minority groups, enabling a more equitable evaluation of treatment effects. Simulations using bootstrapped resampling were conducted to validate that the subset retained key characteristics of the full dataset.---
